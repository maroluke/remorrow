exports.handler = async (event, context) => {
  ...
  const rateLimitKey = `wwf-track-${clientIP}`;
  ...
  try {
    ...
    return {
      ...
      headers: {
        ...headers,
        'Location': 'https://example-wwf-event.com'
      },
      body: '',
    };
  }
