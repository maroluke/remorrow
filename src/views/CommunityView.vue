...
<template>
	<main class="bg-dark">
		...
		<section
			class="px-5 py-10 md:p-20 bg-gradient-to-tr from-rich-electric-blue to-dark-sky-blue flex justify-center"
		>
			...
			<TitleParagraphItem
				...
				class="gap-10 !mb-0 !items-start justify-center drop-shadow-md max-w-screen-md w-full"
			>
				<template #title>
