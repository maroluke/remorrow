...
<template>
    <footer class="bg-black px-5 pt-10 pb-10 h-screen flex flex-col justify-end">
        <div class="absolute w-full h-full bottom-0 left-0 z-10">
            <img loading="lazy" src="/public/sunrise-over-Earth_1600.jpg" alt="Globe from outta space" class="z-10 block">
        ...
        <div class="drop-shadow-md z-20 pt-28">
            ...
            <h4 class="font-medium mt-5">Gemeinsam für ein<br /><span class="text-rich-electric-blue font-medium">besseres
                    Morgen</span>.</h4>
            <p class="font-medium mt-5 text-base">
                Lass uns zusammen handeln.<br />
                fortomorrow.world<br />
            </p>
        ...
        <div class="z-20 opacity-30">
            <h4 class="font-medium text-sm">Credits</h4>
