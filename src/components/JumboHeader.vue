...
<template>
	<section
		id="jumboHeader"
		class="text-snow transition-all duration-500 flex flex-col pb-10 relative"
	>
		<div
			class="object-cover flex-grow bg-cover bg-no-repeat flex items-end px-5"
			:class="class"
			:style="{ backgroundImage: `url(./${src})` }"
		>
			<h1 class="pt-5 drop-shadow-contrast">
				<slot name="title">Titel</slot>
			</h1>
		</div>

		<div
			class="flex gap-10 flex-col items-center px-5 pt-5 z-20 flex-shrink"
		>
			<div>
				<p>
